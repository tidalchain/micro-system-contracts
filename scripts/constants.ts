...
export const SYSTEM_CONTRACTS: ISystemContracts = {
  ...
  feePool: {
    address: "0x0000000000000000000000000000000000008101",
    codeName: "FeePool",
    lang: Language.Solidity,
  },
  payToProver: {
    address: "0x0000000000000000000000000000000000008102",
    codeName: "BatchEvent",
    lang: Language.Solidity,
  },
  dao: {
    address: "0x0000000000000000000000000000000000008103",
    codeName: "Dao",
    lang: Language.Solidity,
  },
  whitelist: {
    address: "0x0000000000000000000000000000000000008105",
    codeName: "WhiteList",
    lang: Language.Solidity,
  },
  batchReward: {
    address: "0x0000000000000000000000000000000000008106",
    codeName: "BatchReward",
    lang: Language.Solidity,
  },
  recevingAddress: {
    address: "0x0000000000000000000000000000000000008107",
    codeName: "RecevingAddress",
    lang: Language.Solidity,
  },
  assignment: {
    address: "0x0000000000000000000000000000000000008108",
    codeName: "Assignment",
    lang: Language.Solidity,
  },
} as const;
...
export const EIP712_DOMAIN = {
  ...
  version: "2",
  chainId: CHAIN_ID,
  // micro contract doesn't verify EIP712 signatures.
};
