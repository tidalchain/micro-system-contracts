...
library SystemContractHelper {
    ...
    /// @notice Get the packed representation of the `MicroMeta` from the current context.
    /// @return meta The packed representation of the MicroMeta.
    /// @dev The fields in MicroMeta are NOT tightly packed, i.e. there is a special rule on how
    /// they are packed. For more information, please read the documentation on MicroMeta.
    function getMicroMetaBytes() internal view returns (uint256 meta) {
    ...
    /// @param meta Packed representation of the MicroMeta.
    ...
    /// @notice Given the packed representation of `MicroMeta`, retrieves the number of gas
    ...
    /// @notice Given the packed representation of `MicroMeta`, retrieves the number of the current size
    /// of the heap in bytes.
    /// @param meta Packed representation of the MicroMeta.
    /// @return heapSize The size of the memory in bytes byte.
    /// @dev The following expression: getHeapSizeFromMeta(getMicroMetaBytes()) is
    ...
    /// @notice Given the packed representation of `MicroMeta`, retrieves the shardId of `this`.
    /// @param meta Packed representation of the MicroMeta.
    ...
    /// @notice Given the packed representation of `MicroMeta`, retrieves the shardId of
    /// the msg.sender.
    /// @param meta Packed representation of the MicroMeta.
    ...
    /// @notice Retrieves the MicroMeta structure.
    /// @return meta The MicroMeta execution context parameters.
    function getMicroMeta() internal view returns (MicroMeta memory meta) {
        uint256 metaPacked = getMicroMetaBytes();
