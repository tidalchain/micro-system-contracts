...
export function signedTxToTransactionData(tx: Transaction) {
  ...
  function legacyTxToTransactionData(tx: any): TransactionData {
    return {
      ...
      gasPerPubdataByteLimit: micro.utils.DEFAULT_GAS_PER_PUBDATA_LIMIT,
  ...
  function eip712TxToTransactionData(tx: any): TransactionData {
    return {
      ...
      to: tx.to!,
      gasLimit: tx.gasLimit!,
      gasPerPubdataByteLimit: tx.customData.gasPerPubdata || micro.utils.DEFAULT_GAS_PER_PUBDATA_LIMIT,
      maxFeePerGas: tx.maxFeePerGas,
      maxPriorityFeePerGas: tx.maxPriorityFeePerGas,
      ...
      factoryDeps: tx.customData.factoryDeps.map(micro.utils.hashBytecode),
